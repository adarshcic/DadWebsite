...
BEGIN
{
  ...
  $postmaster        = '';
  @referers          = qw(deepdiveconsulting.co.uk www.deepdiveconsulting.co.uk);
  @allow_mail_to     = qw(lekhprakash.bhagawan-cic-uk@ibm.com lekhprakash.bhagawan-cic-uk@ibm.com);
  @recipients        = ();
  %recipient_alias   = ();
